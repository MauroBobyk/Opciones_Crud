<?php
// =============================================================
// setup.php - Creación automática de la base de datos (V3)
// -------------------------------------------------------------
...
<head>
    <meta charset="UTF-8">
    <title>Crear Base de Datos - V3</title>
...
<header class="dark-header">
    <div class="dark-header-inner">
        ...
        <span class="dark-badge">Setup BD</span>
    </div>
</header>
<main class="dark-main container">
    <div class="dark-form">
        <h2 class="mb-3">Crear base de datos</h2>
        <?php if ($exito): ?>
            ...
            <p class="text-muted">
                Ya podés usar el CRUD normalmente. Este botón crea la BD y la tabla
                si no existen, sin necesidad de ejecutar SQL a mano.
            </p>
        <?php else: ?>
